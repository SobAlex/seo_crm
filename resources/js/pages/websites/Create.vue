    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h1 class="text-2xl font-bold mb-4">Создание сайта</h1>
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div>
                            ...
                            <Input id="cms" v-model="form.cms" placeholder="WordPress, Laravel, etc." />
                        </div>

                        <div>
                            <Label for="region">Регион</Label>
                            <Input id="region" v-model="form.region" placeholder="Россия, Москва, etc." />
                        </div>
...
import { store } from '@/actions/App/Http/Controllers/WebsiteController'
